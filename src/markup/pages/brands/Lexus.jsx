		...
		<section className="section-area section-sp2 ServiceBox1 IconBox1">
          <div className="container">
            <div class="heading-bx text-center">
              ...
              <p>
			  To get your Lexus service, repair or replacement works done in Saudi Arabia, Just dial <a href="tel:966557835647">+966 55 783 5647
</a> or visit us directly at our workshop, our technicians are ready to take care of your car.
  ...
  <div className="row mb-10">
    ...
    <div className="col-xl-4 col-sm-12 col-12">
      <div className="counter-style-1">
        ...
        <h5 className="counter-text">Lexus Transmission Repair</h5>
      </div>
    </div>
    <div className="col-xl-4 col-sm-12 col-12">
      <div className="counter-style-1">
...
Lexus Touchless Wheel Alignment
        </h5>
      </div>
    </div>
    <div className="col-xl-4 col-sm-12 col-12">
    ...
    <div className="col-xl-4 col-sm-12 col-12">
      <div className="counter-style-1">
        ...
        <h5 className="counter-text">Lexus AC Repair</h5>
      </div>
    </div>
    ...
    <div className="col-xl-4 col-sm-12 col-12">
      <div className="counter-style-1">
        ...
        <h5 className="counter-text">Lexus Car Detailing</h5>
      </div>
    </div>
    <div className="col-xl-4 col-sm-12 col-12">
      <div className="counter-style-1">
    ...
    <div className="col-xl-4 col-sm-12 col-12">
      <div className="counter-style-1">
        ...
        <h5 className="counter-text">
Lexus Engine Cooling System Repair
        </h5>
      </div>
    </div>
    <div className="col-xl-4 col-sm-12 col-12">
